...
from catalog_app.views import ProductListView, ContactCreateView, ProductDetailView, RecordListView, RecordDetailView, \
    ...
    ProductUpdateView, ProductCategoryUpdateView, ProductDescriptionUpdateView, change_is_published
...
urlpatterns = [
    ...
    path('product_update_category/<int:pk>/', ProductCategoryUpdateView.as_view(), name='product_category'),
